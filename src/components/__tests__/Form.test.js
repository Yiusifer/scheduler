...
import { render, cleanup, fireEvent, getByText, getByPlaceholderText } from "@testing-library/react";
...
describe("Form", () => {
  ...
  it("validates that the student name is not blank", () => {
    ...
    const { getByText } = render(<Form interviewers={interviewers} onSave={fn} />);
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const { getByText } = render(<Form onSave={fn} interviewers={interviewers} interviewer={null} />);
